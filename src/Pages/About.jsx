...
return (
  <div className="relative min-h-screen w-full">
    <Menubar />
    <div className="w-full min-h-screen relative bg-gradient-to-r from-[#0f2027] via-[#203a43] to-[#2c5364] flex flex-col-reverse lg:flex-row items-center justify-center px-2 py-8 gap-8">
      {/* Left Section */}
      <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start gap-8 py-6 px-2 sm:px-6 text-white">
        ...
        <h3
          ...
          className="text-lg sm:text-xl flex items-center gap-2 text-center lg:text-left"
        >
        ...
        <motion.p
          ...
          style={{ fontFamily: "sitefont" }}
          className="flex items-center gap-2 w-full max-w-xl leading-relaxed text-center lg:text-left"
        >
